...
libmain(int argc, char **argv)
{
  ...
  80007e:	c7 04 24 4b 0f 80 00 	movl   $0x800f4b,(%esp)
  ...
  800093:	c7 04 24 5b 0f 80 00 	movl   $0x800f5b,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800254:	0f be 80 78 0f 80 00 	movsbl 0x800f78(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800373:	ff 24 85 08 10 80 00 	jmp    *0x801008(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800446:	c7 44 24 08 99 0f 80 	movl   $0x800f99,0x8(%esp)
  80044d:	00 
  ...
  80047a:	75 07                	jne    800483 <vprintfmt+0x19e>
				p = "(null)";
  80047c:	c7 45 d4 89 0f 80 00 	movl   $0x800f89,-0x2c(%ebp)
			if (width > 0 && padc != '-')
...
00800b93 <after_sysenter_label68>:
  ...
  800ba9:	00 
  800baa:	c7 44 24 08 7c 11 80 	movl   $0x80117c,0x8(%esp)
  800bb1:	00 
  800bb2:	c7 44 24 04 2b 00 00 	movl   $0x2b,0x4(%esp)
  800bb9:	00 
  800bba:	c7 04 24 99 11 80 00 	movl   $0x801199,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c7c:	c7 04 24 a7 11 80 00 	movl   $0x8011a7,(%esp)
  ...
  800ca9:	c7 04 24 ac 11 80 00 	movl   $0x8011ac,(%esp)
  ...
  800cbf:	e8 53 f4 ff ff       	call   800117 <vcprintf>
	cprintf("\n");
  800cc4:	c7 04 24 59 0f 80 00 	movl   $0x800f59,(%esp)
