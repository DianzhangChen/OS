...
umain(int argc, char **argv)
{
  ...
  80004a:	e8 b9 0a 00 00       	call   800b08 <sys_cputs>
}
  80004f:	c9                   	leave  
  800050:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  800079:	a3 08 20 80 00       	mov    %eax,0x802008
	//thisenv = envs + ENVX(sys_getenvid());

	cprintf("the thisenv is\n");
  80007e:	c7 04 24 32 0f 80 00 	movl   $0x800f32,(%esp)
  800085:	e8 ee 00 00 00       	call   800178 <cprintf>
	cprintf("the thisenv is %x\n", thisenv);
  80008a:	a1 08 20 80 00       	mov    0x802008,%eax
  80008f:	89 44 24 04          	mov    %eax,0x4(%esp)
  800093:	c7 04 24 42 0f 80 00 	movl   $0x800f42,(%esp)
  ...
  8000a5:	a3 04 20 80 00       	mov    %eax,0x802004
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800254:	0f be 80 5f 0f 80 00 	movsbl 0x800f5f(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800373:	ff 24 85 ec 0f 80 00 	jmp    *0x800fec(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800446:	c7 44 24 08 80 0f 80 	movl   $0x800f80,0x8(%esp)
  80044d:	00 
  ...
  80047a:	75 07                	jne    800483 <vprintfmt+0x19e>
				p = "(null)";
  80047c:	c7 45 d4 70 0f 80 00 	movl   $0x800f70,-0x2c(%ebp)
			if (width > 0 && padc != '-')
...
00800b93 <after_sysenter_label68>:
  ...
  800ba9:	00 
  800baa:	c7 44 24 08 60 11 80 	movl   $0x801160,0x8(%esp)
  800bb1:	00 
  800bb2:	c7 44 24 04 2b 00 00 	movl   $0x2b,0x4(%esp)
  800bb9:	00 
  800bba:	c7 04 24 7d 11 80 00 	movl   $0x80117d,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ca9:	c7 04 24 90 11 80 00 	movl   $0x801190,(%esp)
  ...
  800cbf:	e8 53 f4 ff ff       	call   800117 <vcprintf>
	cprintf("\n");
  800cc4:	c7 04 24 30 0f 80 00 	movl   $0x800f30,(%esp)
